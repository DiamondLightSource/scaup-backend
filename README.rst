...
.. |code_ci| image:: https://gitlab.diamond.ac.uk/lims/sample-handling-backend/badges/master/pipeline.svg
    :target: https://gitlab.diamond.ac.uk/lims/sample-handling-backend/-/pipelines
    :alt: Code CI

.. |coverage| image:: https://gitlab.diamond.ac.uk/lims/sample-handling-backend/badges/master/coverage.svg
    :target: https://gitlab.diamond.ac.uk/lims/sample-handling-backend/-/pipelines
    :alt: Test Coverage
